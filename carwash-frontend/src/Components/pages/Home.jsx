...
export default function Home() {
  ...
  return (
    <>
      ...
      />
      <div className="min-h-[100vh] bg-[#171717] text-[#fff] flex flex-col items-center justify-center text-center p-6  sm:flex ">
        <div
          ref={comp}
        ...
        >
          ...
          <p className="text-xl mb-8 max-w-2xl">{t("home.welcome.subtitle")}</p>

          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 ">
            {["services", "packages", "bookings"].map((key) => (
              <div
                key={key}
                className="bg-[#fff] text-[#1d1d1d] p-6 rounded-lg shadow-lg hover:shadow-[#4d3577] transition-shadow scale-[0.9]"
              >
        ...
        >
          ...
          <div
            ref={leftElementRef}
            className="left w-[700px] max-lg:w-[300px] h-full  "
          >
            <img
      ...
      {/* Mobileview */}
      <div
        className={`MobileContent flex flex-col items-center p-3 lg:hidden fixed bottom-0 w-full ${
          expand ? "h-[400px] justify-center " : "h-[100px] "
        } transition-all duration-350   lg:w-[500px]  sm:hidden rounded-t-[90px] bg-gray-900/80 backdrop-blur-md overflow-y-hidden z-100 `}
        onClick={handleMouseEnter}
        onMouseLeave={handleMouseLeave}
      >
        <div
          className={`Swipetext flex flex-col items-center text-2xl p-3 ${
            expand ? "hidden" : "flex"
          } bg-gradient-to-r from-orange-400 to-pink-600  text-transparent bg-clip-text  `}
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        >
          <div className="arrowicon text-2xl text-orange-600 pb-2 animate-bounce">
            <MdOutlineKeyboardDoubleArrowUp />
          </div>
          <h2>
            {t("home.welcome.Swipe")}
            </h2>
        </div>
        ...
        <div className="cardhead mt-2 text-center text-amber-50">
          <p className="text-xl  max-w-2xl">{t("home.welcome.subtitle")}</p>
        </div>
        ...
        <div className="socialIcons flex justify-evenly gap-3 p-3 mt-2 items-center text-center">
          ...
          <div className="social-button">
            <button className="relative w-12 h-12 rounded-full group pointer-cursor">
              ...
              <a
                href=" https://wa.me/+393206649855"
                className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-green-400    rounded-full"
              >
                <svg
                  viewBox="0 0 15 16"
                  fill="white"
