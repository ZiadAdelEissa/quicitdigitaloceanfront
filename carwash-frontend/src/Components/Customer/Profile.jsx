...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen  text-[#b4b4b4] p-4 md:p-8">
      ...
      <div className="pmwelcome sticky mt-[90px] flex flex-wrap justify-evenly sm:hidden gap-[30px] items-center w-full h-36 rounded-b-[60px] bg-[#6a6a6a00] backdrop-blur-xl drop-shadow-blue-900 animate-(--animate-fade-in-scale) font-(--font-hand) " >
