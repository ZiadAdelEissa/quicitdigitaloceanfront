...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen  text-[#b4b4b4] p-4 md:p-8">
      ...
      <div className="pmwelcome sticky mt-[90px] flex flex-wrap justify-center sm:hidden gap-[30px] items-center w-full h-36 rounded-b-[90px] bg-[#6a6a6a00] backdrop-blur-xl drop-shadow-blue-900 animate-(--animate-fade-in-scale)  " >
        <p className="flex flex-wrap  gap-5  text-xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 h-16  text-transparent bg-clip-text animate-(--animate-fade-in2-scale) ">Welcome <span>{profile?.name || 'N/A'}</span></p>
        </div>
