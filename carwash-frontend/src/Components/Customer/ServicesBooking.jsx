...
export default function ServicesBooking() {
  ...
  const { selectedService } = location.state || {}; // Get selectedService from state

  const [formData, setFormData] = useState({
    serviceId: selectedService ? selectedService._id : "", // Pre-fill serviceId
    branchId: "",
    bookingDate: "",
    bookingTime: "",
    notes: "",
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // If a service was passed, ensure it's selected in the dropdown
        if (selectedService) {
